...
import static dev.verloren.midnight.parser.CompactParserUtil.*;
...
public class CompactParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // PRAGMA pragma_identifier version_expr SEMICOLON
  public static boolean pragma_form(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, pragma_identifier(b, l + 1));
    r = p && report_error_(b, version_expr(b, l + 1)) && r;
    r = p && consumeToken(b, SEMICOLON) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // <<pragmaIdentifier>>
  static boolean pragma_identifier(PsiBuilder b, int l) {
    return pragmaIdentifier(b, l + 1);
  }
