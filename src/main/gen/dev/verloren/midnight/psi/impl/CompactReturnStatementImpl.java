...
public class CompactReturnStatementImpl extends ASTWrapperPsiElement implements CompactReturnStatement {

  public CompactReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
