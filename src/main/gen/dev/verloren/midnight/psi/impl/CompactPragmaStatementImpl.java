...
public class CompactPragmaStatementImpl extends ASTWrapperPsiElement implements CompactPragmaStatement {

  public CompactPragmaStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
