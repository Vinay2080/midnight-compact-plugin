...
public class CompactWitnessDeclarationImpl extends ASTWrapperPsiElement implements CompactWitnessDeclaration {
  ...
  public CompactSimpleParameterList getSimpleParameterList() {
    return findNotNullChildByClass(CompactSimpleParameterList.class);
  }
