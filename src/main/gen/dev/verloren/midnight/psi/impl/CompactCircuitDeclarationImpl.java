...
public class CompactCircuitDeclarationImpl extends ASTWrapperPsiElement implements CompactCircuitDeclaration {

  public CompactCircuitDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CompactParameterList getParameterList() {
    return findNotNullChildByClass(CompactParameterList.class);
  }
