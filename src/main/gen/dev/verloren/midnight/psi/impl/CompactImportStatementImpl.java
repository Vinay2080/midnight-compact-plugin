...
public class CompactImportStatementImpl extends ASTWrapperPsiElement implements CompactImportStatement {

  public CompactImportStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
