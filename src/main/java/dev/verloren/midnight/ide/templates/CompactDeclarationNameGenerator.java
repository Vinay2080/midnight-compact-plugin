...
public final class CompactDeclarationNameGenerator {
  ...
  public static @NotNull String generateName(@NotNull CompactDeclarationType type, @Nullable PsiElement context) {
    return generateName(type.getBaseName(), null, context);
  }
  ...
  public static @NotNull String generateName(
    ...
    return generateName(type.getBaseName(), explicitName, context);
  }
  ...
  public static @NotNull String generateName(@NotNull String baseName, @Nullable PsiElement context) {
    return generateName(baseName, null, context);
  }

  /**
   * Core generation routine: returns the explicit name if provided, otherwise calculates the lowest
   * available numbered name based on the base name and enclosing scope.
   *
  ...
  public static @NotNull String generateName(
    ...
    Set<String> existingNames = collectExistingNamesInScope(context);
  ...
  private static void addNameIfPresent(@NotNull Set<String> names, @Nullable CompactNamedElement element) {
    if (element != null) {
