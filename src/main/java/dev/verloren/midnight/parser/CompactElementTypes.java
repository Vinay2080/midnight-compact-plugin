...
/**
 * Static registry of all composite AST element types generated by {@link CompactParser}.
 *
 * <p>These constants represent non-terminal grammar productions including:
 * <ul>
 *   <li><b>Top-Level Declarations:</b> Pragma, include, import, export, module, struct, enum, contract, type alias, ledger, witness, constructor, circuit.</li>
 *   <li><b>Parameters & Patterns:</b> Generic parameters/arguments, simple parameter lists, pattern parameter lists, typed IDs, destructuring patterns.</li>
 *   <li><b>Types:</b> Type references, builtin type expressions, tuple types.</li>
 *   <li><b>Statements:</b> Block, if, for, const binding statements, return, expression statements.</li>
 *   <li><b>Expressions:</b> Binary, unary, ternary, call, cast, member access, struct literal, tuple, lambda expressions.</li>
 * </ul>
 * </p>
 *
 * @see dev.verloren.midnight.psi.CompactElementFactory
 */
